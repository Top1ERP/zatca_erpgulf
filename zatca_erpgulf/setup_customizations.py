...
,
        {
            ...
            "reqd": 0,
            "description": (
                "Enable local/debug ZATCA advance payment tax invoice handling "
                "from Payment Entry. This does not submit advance payments to ZATCA by itself."
            ),
            "_fallback_insert_after": [
        ...
        },
        {
            ...
            "reqd": 0,
            "description": (
                "Controls how advance payment tax invoices are handled. "
                "The current foundation uses Local Only/debug XML generation only."
            ),
            "_fallback_insert_after": [
    ...
    "Payment Entry": [
        ...
        },
        {
            ...
            "allow_on_submit": 1,
            "description": (
                "Marks this Payment Entry as the source for a ZATCA advance tax invoice."
            ),
            "_fallback_insert_after": [
