...
CRITICAL_CUSTOM_FIELDS: dict[str, list[dict[str, Any]]] = {
    "Company": [
        ...
        },
        {
            ...
            "no_copy": 1,
            "description": (
                "Controls whether advance payment tax invoices are kept local only, "
                "submitted to ZATCA, or disabled for this company."
            ),
            "_fallback_insert_after": [
        ...
        },
        {
            ...
            "reqd": 0,
            "no_copy": 1,
            "description": "Enable only when advance tax invoice signing is fully tested for this company.",
            "_fallback_insert_after": [
        ...
        },
        {
            ...
            "reqd": 0,
            "no_copy": 1,
            "description": "Enable only for a real pilot customer after signing/API integration is ready.",
            "_fallback_insert_after": [
