        ...
        if (frm.doc.custom_zatca_full_response) {
            try {
                ...
                if (ztcaresponse.trim().toUpperCase().startsWith("ERROR")) {
                    ...
                    let badgeHtml = '<div class="zatca-badge-container"><img src="/assets/zatca_erpgulf/js/badges/zatca-failed.png" alt="Failed" class="zatca-badge" width="110" height="36" style="display:block; margin-top:0; margin-left:auto; margin-right:0;"></div>';
                    frm.set_df_property('custom_zatca_status_notification', 'options', badgeHtml);
                    frm.refresh_field('custom_zatca_status_notification');
                ...
                if (duplicateErrorExists && errors.length === 0) {
                    ...
                    let badgeHtml = '<div class="zatca-badge-container"><img src="/assets/zatca_erpgulf/js/badges/zatca-duplicated.png" alt="Duplicate" class="zatca-badge" width="110" height="36" style="display:block; margin-top:0; margin-left:auto; margin-right:0;"></div>';
                    frm.set_df_property('custom_zatca_status_notification', 'options', badgeHtml);
                    frm.refresh_field('custom_zatca_status_notification');
                ...
                if (status === 'PASS' || (status === 'FAILED' && errors.length === 0)) {
                    if (reportingStatus === 'CLEARED') {
                        ...
                        badgeHtml = '<div class="zatca-badge-container"><img src="/assets/zatca_erpgulf/js/badges/zatca-cleared.png" alt="Cleared" class="zatca-badge" width="110" height="36" style="display:block; margin-top:0; margin-left:auto; margin-right:0;"></div>';

                    } else if (reportingStatus === 'REPORTED') {
                        console.log('PASS - Reported');
                        badgeHtml = '<div class="zatca-badge-container"><img src="/assets/zatca_erpgulf/js/badges/zatca-reported.png" alt="Reported" class="zatca-badge" width="110" height="36" style="display:block; margin-top:0; margin-left:auto; margin-right:0;"></div>';
                    }
                }
                ...
                // 🟡 WARNING Conditions
                    ...
                    if (reportingStatus === 'CLEARED') {
                        ...
                        badgeHtml = '<div class="zatca-badge-container"><img src="/assets/zatca_erpgulf/js/badges/zatca-cleared-warning.png" alt="Cleared with Warning" class="zatca-badge" width="110" height="36" style="display:block; margin-top:0; margin-left:auto; margin-right:0;"></div>';
                    } else if (reportingStatus === 'REPORTED') {
                        console.log('WARNING - Reported with Warning');
                        badgeHtml = '<div class="zatca-badge-container"><img src="/assets/zatca_erpgulf/js/badges/zatca-reported-warning.png" alt="Reported with Warning" class="zatca-badge" width="110" height="36" style="display:block; margin-top:0; margin-left:auto; margin-right:0;"></div>';
                    }
                }
                ...
                // 🔴 FAILED Condition (only if real errors remain)
                    ...
                    badgeHtml = '<div class="zatca-badge-container"><img src="/assets/zatca_erpgulf/js/badges/zatca-failed.png" alt="Failed" class="zatca-badge" width="110" height="36" style="display:block; margin-top:0; margin-left:auto; margin-right:0;"></div>';
                }
